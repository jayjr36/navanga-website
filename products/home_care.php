<div class="landingpage pt-12">
    <div class="box_">
        <template>
            ...
            A wide of range of the home healthcare services for short and long term medical conditions that require support from medical professionals at home.</p>
...
<!--                     <button class="infobox_-createbtn">Contact Us</button>
 -->                </div>
        ...
        <div class="display">
            <img class="display-nft" src="https://img.freepik.com/premium-photo/senior-man-volunteer-nurse-support-caregiver-help-with-elderly-medical-nursing-home-smile-happy-trust-community-employee-working-healthcare-charity-house-interior-living-room_590464-85939.jpg?w=740" alt="unsplash-OG44d93i-NJk" border="0">
        </div>
    </div>
