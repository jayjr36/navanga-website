<div class="landingpage pt-12">
    <div class="box_">
        <template>
            <div class="infobox_">
            <p class="infobox_-boldtext fg-black" style="font-size: 2rem;">
            We are providing different packages of wellness programs for companies, organizations, individuals and groups. 
</p>
<p class="infobox_-slimtext fg-black">
Please contact us for our special services including health talks, gym management, stress management, mindful activities, medical checkups, short term health promotions, nutritions, life coaching, and wellness workshops
</p>
                <div class="infobox_-btnwrapper">
                    <v-btn text @click="[contactUsModal = true, applyStyle('.contactUsModal')]" class="infobox_-explorebtn selected_ blur">Contact Us</v-btn>
<!--                     <button class="infobox_-createbtn">Contact Us</button>
 -->                </div>
            </div>
        </template>
        ...
        <div class="display">
            <img class="display-nft" src="https://res.cloudinary.com/soshub-co/image/upload/v1678859150/cld-sample-4.jpg" alt="unsplash-OG44d93i-NJk" border="0">

        </div>
    </div>

    <div class="started">
        <p class="started-boldtext fg-black">Getting started</p>
        <p class="started-slimtext fg-black">
        Facilitate knowledge sharing among medical professionals to enhance care quality.<br>

        </p>
        <div hidden class="started-_items">
            <div class="_itemwrapper">
                <div class="started-_items-_item">
            ...
            <div class="_itemwrapper">
                <div class="started-_items-_item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewbox_="0 0 36 31">
...
<!-- <template>
  <v-card class="mx-auto shadeless nutrition pt-8" color="#26c6da" dark max-width="100%">
    <div class="pt-12">
      <v-card-title>
        <span class="text-h6 text-black font-weight-light" style="text-align: justify !important;
        text-justify: inter-word !important;">
          We are providing different packages of the wellness programs for companies, organizations, individuals and groups. Please contact us for our special services including health talks, gym management, stress management, mindful activities, medical checkups, short term health promotions, nutritions, life coaching, and wellness workshops</span>
      </v-card-title>
      ...
      <v-card-text class="text-h5 font-weight-bold">
        <div class="w3-row">
          <div class="w3-half w3-container">
            <figure>
              <img src="https://img.freepik.com/free-photo/top-view-sliced-vegetable-salad-peppered-with-chicken-slices-inside-plate-with-fresh-vegetables-blue-desk-snack-lunch-salad-vegetable-food_140725-38926.jpg?w=740&t=st=1691506728~exp=1691507328~hmac=f59f32ea8bb729fe838f7e54af08aa5bdd4bac8c8fa018caa59ccdaad51e32c7" />
              <figcaption class="fg-black p-2">
          ...
          <div class="w3-half w3-container">
            <div class="fg-dark">
              "Step into a world where food is your ally, not your enemy. Navanga's nutrition packages, shaped by the wisdom of nutritionists and doctors, align with WHO guidelines for a healthier you and a healthier Tanzania."
            </div>
          </div>
        </div>
        ...
        <div class="w3-half w3-container">
          <figure>
            <img src="https://img.freepik.com/free-photo/baby-carrot-sticks-green-bowl-black-surface-healthy-eating-concept-vegan-food-top-view-flat-lay_2829-6072.jpg?t=st=1691505920~exp=1691506520~hmac=07b8088beca6874ce532cbb200743b7c65f66678411245c0b06e5026ea8a7a1b" />
            <figcaption class="fg-black p-2">
              Reimagine your relationship with food with Navanga's innovative nutrition solutions
            </figcaption>
          </figure>
        </div>
        <div class="w3-half w3-container">
          <div class="fg-dark">
            "Ditch the confusion and embrace clarity with Navanga's nutrition offerings. Backed by experts and WHO principles, our packages offer a bridge between balanced eating and modern lifestyles." </div>
        </div>
    </div>
    ...
    <figure>
      <img src="https://img.freepik.com/free-photo/two-raw-seabass-baking-dish-with-spices-old-wooden-table-top-view_2829-20034.jpg?w=360&t=st=1691506029~exp=1691506629~hmac=d446bc3de5d3b79963a44da6ffb2fbfa0a0419d0b2286af9c7af27254b4894d9" />
      <figcaption class="fg-black p-2">
