<div class="landingpage pt-12">
  <div class="box_">
    <template>
      <div class="infobox_">
        <p class="infobox_-boldtext fg-black" style="font-size: 2rem;">
          We provide Tailored Solutions to Address Your Unique Needs.
          Don't face challenges alone,
          Embark on a journey with us for innovative and engaging solutions.
        </p>
        <p class="infobox_-slimtext fg-black">
          Access a private board for convenience. Save costs, gain insights into health, relatives, corporates, and staff.
        </p>
        <div class="infobox_-btnwrapper">
          <v-btn @click="[contactUsModal = true, applyStyle('.contactUsModal')]" text class="infobox_-explorebtn selected_ blur">Contact Us</v-btn>
        </div>
      </div>
    </template>
    ...
    <div class="display">
      <img class="display-nft" src="https://img.freepik.com/free-photo/financial-analyst-with-physical-injury-wearing-medical-neck-collar-office-job-using-cervical-foam-treat-vertebrae-accident-recovering-from-painful-spine-injury-tripod-shot_482257-42460.jpg?w=826&t=st=1692643342~exp=1692643942~hmac=ca06628ee131fe618be7d8ad66a79727044dbfb4d4d48be7177f6669cd8f41c3" alt="unsplash-OG44d93i-NJk" border="0">
  ...
  <div class="started">
    ...
    <p class="started-slimtext fg-black">
      Services offered by expert of consultants professionals
    </p>
...
<!-- <div class="w3-content w3-white" style="max-width:1600px">
  ...
  <header class="w3-display-container w3-wide" id="home">
    ...
    <div id="mouse-scroll" style="position: absolute; top: 46.5%; left: 83%; z-index: 2 !important;">
      <div class="mouse">
    ...
    <section class="mb-8 m-6">
      <div class="page-header pt-12 mt-12 py-md-0" style="background-image:url();min-height:50vh;border-radius:1rem">
      
      
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-8 col-sm-9 text-center mx-auto">
              <h16 class="text-black mb-4">Your Expert Consultants <span class="w3-tag">Guiding Professionals</span></h16>
              <p class="lead text-black mb-sm-6 mb-4">
              We provide Tailored Solutions to Address Your Unique Needs.
          Don't face challenges alone,
          Embark on a journey with us for innovative and engaging solutions.
        </p>
        <v-btn text class="btn btn-white btn-md py-2 w3-border mt-9">Contact Us</v-btn>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="pb-3 pt-7 position-relative" id="section-designer-creators">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-lg-3 ms-auto text-center mb-5 mb-lg-0">
          <img src="https://res.cloudinary.com/soshub-co/image/upload/v1678889105/front-view-smiley-doctor-clinic_u8whpj.jpg" class="w-40" alt="designers">
          <h5 class="text-xl mt-3 mb-1 font-weight-black">Public Health</h5>
          <p class="mx-3">This template comes packed with designer files based on Figma.</p>
        </div>
        <div class="col-md-4 col-lg-3 text-center mb-5 mb-lg-0">
          <img src="https://firebasestorage.googleapis.com/v0/b/navangahealthcare.appspot.com/o/products_files%2Fdoc-black.png?alt=media&token=a2e064ba-3846-4c3e-8e7e-db32298ede1b" class="w-40" alt="developers">
          <h5 class="text-xl mt-3 mb-1 font-weight-black">Medical Care</h5>
          <p class="mx-3">Save months of work when you use our fully coded components and pages.</p>
        </div>
        <div class="col-md-4 col-lg-3 me-auto text-center">
          <img src="https://firebasestorage.googleapis.com/v0/b/navangahealthcare.appspot.com/o/products_files%2Fbusinesswoman-executive-professional-success-concept_01.png?alt=media&token=9e5ae2d7-40de-4f09-961a-93a88ea5902e" class="w-40" alt="creators">
          <h5 class="text-xl mt-3 mb-1 font-weight-black">HR Health</h5>
          <p class="mx-3">Save time and money by helping your team focus on customization and features.</p>
        </div>
      </div>
    </div>
  </section>
