...
<head>
    ...
    <title>NAVANGA | Terms of Use </title>
    <!-- Import Vuesax CSS -->
    ...
    <link rel="icon" href="https://navangahealthcare.co.tz/agency/img/logo.ico" type="image/x-icon">
    ...
    p {
        font-family: 'Gowun Batang', sans-serif !important; color: #000000 !important;
    }
        /* Blockquotes */
        blockquote {
            background-color: #ffffff !important;
        ...
        /* Other specific styles for different elements */
        /* ... */
...
<body>
    <div id="app">
        ...
        <template>
            ...
            <div class="container mt-9  fg-white p-6 w-100 rounded-4" vs-theme="dark" style="color: #000000 !important;">
                <img height="44" width="150" src="https://navangahealthcare.co.tz/img/logo.png" class="navanga-logo pos-absolute pos-top-center c-pointer" style="height: 42px !important; width: 180px !important; top: -10px !important" />
                <br>
                <h2 class="text-center mt-6" style="color: #000000 !important;">
                    Privacy Policy
                    <br>
                    Effective: August 2023
                </h2>
                <br>
                At <span class="text-bold batang justfied" style="color: #000000 !important;">Navanga Healthcare Solutions</span>,
                <span class="justfied" style="color: #000000 !important;"> privacy policy outlines how we collect, how we use, disclose, and
                    safeguard personal data when you interact with our website and participate in co-creating innovative
                    interesting solutions for healthcare challenges. By using our website and providing your information,
                    you consent to the terms and conditions of this privacy policy.</span>
                <br>
                <br>
                <span class="text-bold batang" style="color: #000000 !important;">1. Information We Collect</span> <br>
                We collect the following types of personal information when you register
                with Navanga:
                <br>
                <br>
                <span class="text-bold" style="color: #000000 !important;">a. Full Name:</span>
                To identify and address you properly.
                <br>
                <br>
                <span class="text-bold">b. Email Address:</span>
                To communicate with you and send important updates
                related to your participation.
                <br>
                <br>
                <span class="text-bold">c. Phone Number:</span>
                To contact you for projects-related communications.

                <br>
                <br>
                <span class="text-bold">d. Physical Address:</span>
                To understand your geographical location for potential local events and collaborations.
                <br>
                <br>
                <span class="text-bold">e. Available Days:</span>
                To schedule and plan your participation in co-creation activities and weigh the level of
                efforts (LOE) activities.
                <br>
                <br>
                <span class="text-bold">f. Available Time:</span>
                To determine suitable time slots for engagements and LOE.
                <br>
                <br>
                <span class="text-bold">g. Professional Info (Specialization):</span>
                To assess your expertise and match you with relevant healthcare challenges that need solutions.

                <br>
                <br>
                <span class="text-bold">2. How We Use Your Information</span>
                <br>
                We use the information you provide for the following purposes:
                <br>
                <br>
                a. To facilitate your registration and account management on our website.
                <br>
                <br>
                b. To contact you regarding your participation in co-creation activities and
                provide updates.
                <br>
                <br>
                c. To personalize your experience on our website and tailor the content to
                your interests.
                <br>
                <br>
                d. To improve our website's functionality and user experience.
                <br>
                <br>
                e. To analyze trends and usage patterns for services quality improvement.
                <br>
                <br>
                ...
                <span class="text-bold">3. Data Sharing and Disclosure</span> <br>
                We may share your personal information with third parties under the
                following circumstances:
                <br>
                <br>
                <br>
                <span class="text-bold">a. With your consent:</span>
                We may share your information with third parties
                when you provide explicit consent for a specific purpose.

                <br>
                <br>
                <span class="text-bold">b. Service Providers:</span> We may engage third-party service providers to assist
                us in delivering our services. These providers have limited access to your
                personal information and are contractually obligated to protect its
                confidentiality.
                <br>
                <br>
                <span class="text-bold">c. Legal Compliance:</span> We may disclose your information when required by
                law, court order, or government regulations.
                <br>
                <br>
                <span class="text-bold">d. Business Transfers:</span> In the event of a merger, acquisition, or asset sale,
                your personal information may be transferred to a third party as part of the
                transaction.

                <br>
                <br>
                <span class="text-bold">4. Data Security</span>
                <br>
                ...
                electronic storage method is 100% secure, and we cannot guarantee
                absolute security.

                <br>
                <br>
                <span class="text-bold">5. Your Rights</span>
                <br>
                You have the right to access, correct, update, or delete your personal
                information held by us. If you wish to exercise any of these rights or have
                any privacy-related questions, please contact us at <span class="text-bold text-navanga">privacy@navangahealthcare.com</span>
                <br>
                <br>
                <span class="text-bold">6. Changes to this Privacy Policy</span>
                <br>
                We may update this Privacy Policy from time to time to reflect changes in
                our practices or for legal, operational, or regulatory reasons. Any changes
                made will be effective immediately upon posting the updated Privacy Policy
                on our website.
                <br>
                <br>
                By continuing to use our website after the Privacy Policy has been updated,
                you acknowledge and agree to the revised terms.

                <br>
                <br>

                <span class="text-bold">7. Consent</span>
                <br>
                By using our website and providing your personal information, you consent
                to the collection, use, and disclosure of your information as outlined in this
                Privacy Policy.
                <br>

                <p id="termsAndConditions" class="fSize-6 text-bold batang p-4 text-center">
                    Terms and Conditions
                </p>

                <span>Please note that our website's usage is also governed by our Terms and
                    Conditions, which can be found at
                    <span @click="goToTerms()" class="text-bold text-navanga">www.navangahealthcare.co.tz/terms_of_use.</span>
                </span>
                <br>
                <br>

                Please review both the Privacy Policy and Terms and Conditions carefully
                before using our website or providing any personal information. If you do
                not agree with any part of these documents, please refrain from using our
                services.

                <br>
                <br>
                <span>For any questions or concerns regarding our Privacy Policy or Terms and
                    Conditions, please contact us at <span class="text-bold text-navanga">privacy@navangahealthcare.com</span> </span>
    ...
    <script src="https://cdn.jsdelivr.net/npm/vuesax@next"></script>
                    ...
                    onAuthStateChanged(auth, async (user) => {
                        if (user) {
                            ...
                            const myselfMeI = onSnapshot(doc(db, "users", user.uid), (doc) => {
                                if (doc.exists()) {
                                    let data = doc.data();
                                    this.profileUrl = data['profileUrl'] != null ? data['profileUrl'] : '';
                            ...
                            const unsub = onSnapshot(collection(db, "users"), (querySnapshot) => {
                                ...
                                this.allUsers = querySnapshot.docs.map((doc) => {
                                    const data = {
                                        ...
                                        profileUrl: doc.data().profileUrl != null ? doc.data().profileUrl : '',
