...
<body>
  <div id="app">
    <!-- Add vs-theme="dark" attribute here -->

    <!-- Modal -->

    <?php include "components/navbar.php" ?>
    <?php include "components/sidebars.php" ?>


    <div class="w3-row">
      <div v-if="loggedIn" class="w3-quarter w3-hide-small w3-container" style="width: 19%;">
      </div>
      <div class="w3-rest w3-container" style="padding: 8px 0px !important;">
        <div class="main-container">

          <?php include_once "components/register.php" ?>
          <?php include_once "components/contact_us.php" ?>

          <div class="hide_on_load w3-hide card card-body blur shadow-blur mx-md-4 mt-n6" style="margin-left: 0 !important; margin-right: 0 !important;" :style="{'box-shadow': !isLargeScreen ? 'none !important' : '', 'padding': !isLargeScreen ? '0 !important' : '0'}">

            <!-- HEADER -->
            <template v-if="!loggedIn">
              <section class="pt-3 pb-4" id="count-stats">
                <header>
                  <div class="page-header min-vh-85" :style="{'background-image': isLargeScreen ? '' : 'url(img/adrianne_header_1.JPG)'}">
                    <div>
                      <img class="position-absolute  animate__animated animate__slideIn fixed-top ms-auto w-50 z-index-0 d-none d-sm-none d-md-block border-radius-section border-top-end-radius-0 border-top-start-radius-0 border-bottom-end-radius-0" src="img/adrianne_header_1.JPG" alt="image" loading="lazy" style="height: 100% !important; bottom: 150px !important;">
                    </div>
                    <div class="container">
                      <div class="row">
                        <div class="col-lg-7 d-flex">
                          <div class="card card-body blur text-md-start text-center px-sm-4 shadow-lg mt-sm-4 py-sm-4">
                            <h2 class="text-dark mb-0 animate__animated animate__fadeIn">
                              Welcome to Navanga Healthcare Solutions</h2>
                            <p class="lead text-dark pe-md-5 me-md-5">
                              Your Path to Innovative Healthcare Excellence!
                            </p>

                            <p class="lead text-dark pe-md-5 me-md-5">
                              <span id="typewriter-text">
                                Are you a passionate professional seeking to make a
                                profound impact on the world of healthcare?
                              </span>
                            </p>

                            <!-- <p class="lead text-dark pe-md-5 me-md-5">
                  At Navanga, we're on a mission to revolutionize healthcare in Tanzania and beyond.
                </p> -->
                            <div class="buttons">
                              <button onclick="document.getElementById('regModal').style.display='block'" @click="regModal = true" type="button" class="btn btn-rounded mt-4" style="background-color: #0050fe; color: #ffffff">Register</button>
                              <button type="button" onclick="document.getElementById('contModal').style.display='block'" class="btn btn-rounded btn-outline-secondary mt-4 ms-2">Contact
                                Us</button>
                            </div>
                          </div>
                        </div>
                ...
                <template>
                  <div class="center">
                    ...
                    <vs-dialog v-model="loginModal">
                      <template #header>
                        <h4 class="not-margin p-3">
                          Welcome to <b>NAVANGA</b>
                        </h4>
                      </template>


                      <div class="con-form p-3">
                        <vs-input class="mb-3" v-model="email" placeholder="Email">
                          <template #icon>
                            @
                          </template>
                        </vs-input>
                      ...
                      <template #footer>
                        <div class="footer-dialog p-3">
                          <vs-button :loading="loginFeedbackModal" block @click="loginWithEmail()">
                            Sign In
                          </vs-button>

                          <div class="new p-3" style="cursor:  pointer !important;">
                            New Here? <vs-button style="cursor:  pointer !important;" class="c-ponter" onclick="document.getElementById('regModal').style.display='block'" @click="[loginModal = false,]">Create New Account</button>
                          </div>
                        </div>
                      </template>
                    </vs-dialog>
            ...
            <template v-else>
              <div v-if="page_index === 0" class="mt-6">
                <?php include_once "components/network.php" ?>
              </div>
              <div v-if="page_index === 1" class="mt-6">
                <?php include_once "components/profile.php" ?>
              </div>
              <div v-if="page_index === 2" class="mt-6">
                <?php include_once "components/edit_profile.php" ?>
              </div>
            </template>



            <vs-dialog vs-theme="dark" width="100px" not-close v-model="logoutFeedbackModal">

              <div class="con-content w3-display-middle mt-2">
                <div class="d-flex align-items-center p-3">
                  L<span class="small-loader mt-1"><?php echo $svgSnippet; ?></span> gging y<span class="small-loader mt-1"><?php echo $svgSnippet; ?></span>u Out
                </div>
              </div>
            </vs-dialog>

            <vs-dialog vs-theme="dark" width="100px" not-close v-model="loginFeedbackModal">

              <div class="con-content w3-display-middle mt-2">
                <div class="d-flex align-items-center p-3">
                  L<span class="small-loader mt-1"><?php echo $svgSnippet; ?></span>gging y<span class="small-loader mt-1"><?php echo $svgSnippet; ?></span>u In
                </div>
              </div>
            </vs-dialog>


            <?php include_once "components/privacy.php" ?>
  ...
  <script type="module">
    ...
    new Vue({
      ...
      data() {
        return {
          ...
          countryCodes: [{
            ...
            {
              code: "+225",
              text: "C�0�0te d'Ivoire (Ivory Coast) (+225)",
              flag: '<span class="fi fi-ci fis w3-round-medium"></span>',
            },
            {
              code: "+253",
      ...
      watch: {
        password(newValue) {
          this.passwordMatch = newValue === this.repeatPassword;
          const strength = zxcvbn(newValue);
          this.passwordStrength = strength.score >= 3 ? 'strong' : strength.score >= 2 ? 'medium' :
            'weak';
        },
        repeatPassword(newValue) {
          this.passwordMatch = newValue === this.password;
        },
        regModal(now, then) {
          console.log("log me...")
          this.changeCounts++;
      ...
      methods: {
        ...
        mailMe() {
          ...
          $.post("../server/realtime.php", {
            ...
            msg: this.enquiry + "<br><br>Phone number: " + " " + this.phoneNumber +
              "<br>Product of Interest: Registration Portal",
        ...
        timeAgoFormat(dateString) {
          ...
          return dateString != '' ? Math.floor(seconds) + " second" + (seconds === 1 ? "" : "s") +
            " ago" : 'Registration Date not Found';
        },
        handleFileSelect() {
          // this function will be called when the file input below is changed
          var file = document.getElementById("fileInput").files[
            0]; // get a reference to the selected file
        ...
        async regWithEmail() {
          ...
          if (this.passwordMatch) {
            ...
            // Ensure that the email field is always set to a valid value.
            ...
            await updateProfile(auth.currentUser, {
              ...
              photoURL: 'https://img.freepik.com/free-icon/user_318-725053.jpg?t=st=1692346228~exp=1692346828~hmac=7ba63506e5f47dfb0e7079afef28c44c4cf1a8d17b43c44c1532c07b946fe257',
            }).then(() => {
              window.location.reload();
            });
          }
        ...
        notMeUsers() {
          ...
          this.allUsers.forEach((user) => {
            ...
            if (user.email != this.email && user.firstName != null) {
        ...
        usersScope() {
          ...
          this.allUsers.forEach(user => {
            ...
            this.isDateToday(user.registrationDate) ? usersToday.push(user) :
              ...
              registrationDate.getMonth() === thisMonth && registrationDate.getFullYear() ===
              thisYear ? usersThisMonth.push(user) :
            ...
            if (user) {
              ...
              const myselfMeI = onSnapshot(doc(db, "users", user.uid), (doc) => {
                if (doc.exists()) {
                  ...
                  this.selectedCountryCode = data['countryCode'] !=
                    undefined ? data['countryCode'] : this
                    .selectedCountryCode;
                ...
                this.allUsers = querySnapshot.docs.map((doc) => {
                  ...
                  const data = {
                    ...
                    profileUrl: doc.data().profileUrl !=
                      null ? doc.data().profileUrl : 'https://img.freepik.com/free-icon/user_318-725053.jpg?t=st=1692346228~exp=1692346828~hmac=7ba63506e5f47dfb0e7079afef28c44c4cf1a8d17b43c44c1532c07b946fe257',
                    registrationDate: doc.data()
                      .registrationDate != null ? doc
                      .data().registrationDate : '',
                    bio: doc.data().bio,
                    availableDays: doc.data().availableDay,
                    availableTimeStart: doc.data()
                      .availableTimeStart,
                    availableTimeEnd: doc.data()
                      .availableTimeEnd,
              ...
              const deviceNames = ['Mozilla Firefox', 'Apple Safari', 'Google Chrome',
                'Unknown Browser'
              ];

              const visits = onSnapshot(collection(db, "page_visits"), (
                querySnapshot) => {
                ...
                this.avatarImages = querySnapshot.docs.map((doc) => {
                  ...
                  if (deviceName === 'Mozilla Firefox') {
                    avatar =
                      'https://www.pngmart.com/files/15/Cool-Firefox-Purple-PNG.png';
                    ...
                    avatar =
                      'https://w7.pngwing.com/pngs/123/870/png-transparent-web-browser-android-application-software-firefox-icon-blue-earth-infographic-blue-globe.png';
                  }
        ...
        openNotification(position = null) {
          ...
          to see the documents of the previous versions you can do it here �9�7 Vuesax3.x`
          })
        },
        uploading() {
          ...
          setTimeout(() => {
            function sendMessageToIframe(message) {
              ...
              const iframe = document.getElementById(
                'imgCropper'); // Replace 'myIframe' with the ID of your iframe.
        ...
        openToTrackScroll() {
          $(document).ready(function() {
            ...
            function scrollFunction() {
              ...
              var scrollPosition = $('.vs-dialog__content').scrollTop() + $(
                '.vs-dialog__content').height();
      ...
      mounted() {
        ...
        function fetchUsers() {
          const obfuscatedURL =
            "aHR0cHM6Ly91cy1jZW50cmFsMS1uYXZhbmdhaGVhbHRoY2FyZS5jbG91ZGZ1bmN0aW9ucy5uZXQvZ2V0QWxsVXNlcnM=";
        ...
        onAuthStateChanged(auth, async (user) => {
          if (user) {
            ...
            // User is signed in
            // ...
            this.isAdmin = user.uid == '744xQNXAacVR4Yk63SRACl7dUzA3' || user.uid ==
              'ZpDOgs3ptOSGaTUgJF29I0B4z1v2' ? true : false;
